                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            @elseif($order->Status === 'Delivered')
                                <a href="/order/processDelivery/{{$order->OrderId}}" onclick="return confirm('Process this Return?');"><i class="material-icons" style="font-size:36px;color:red;" title="Process Return">keyboard_return</i></a>
