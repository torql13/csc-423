    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p>
                    <form action="{{ action('VendorsController@searchActive') }}" method="get" id="searchForm" onsubmit="$('#submit').prop('disabled', true);">
                        <fieldset>
                            <div class="form-row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td><a href="/vendor/view/{{$vendor->VendorId}}"> <i class="material-icons" style="font-size:36px;color:green;" title="View">visibility</i></a>
                                ...
                                <a href="/report/topTenReturned/{{$vendor->VendorId}}"><i class="material-icons" style="font-size:36px;color:black;" title="Top Ten Returned Items">reorder</i></a>
                            </td>
                        </tr>
                        @endforeach
                    </table>
